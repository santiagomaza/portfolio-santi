...
export const kiosquitoelbarbaProy = {
  nombreProyecto: "Kiosquito el Barba",
  descripcionProyecto: "Proyecto final grupal realizado para una asignatura de la Universidad en primer año.",
  tecnologiasUsadas: "HTML, CSS, JS, Bootstrap, Json Server",
  urlProyecto: "https://kiosquitoelbarba.netlify.app/index.html",
  urlGithub: "https://github.com/santiagomaza/kiosquitoelbarba-Front",
  urlImagen: kiosquitoelbarbaImg,
  textoAlt: "bgeKiosquitoElBarba"
}
...
export const theFilmZoneProy = {
  ...
  urlImagen: thefilmzoneImg,
  textoAlt: "bgeTheFilmZone"
}